...
;*               instruction (and CPUs really should all implement
;*               div in software, it's both complex to implement
;*               (at all, let alone with any semblance of speed)
;*               and rare in most code).
;*
;*****************************************************************************
